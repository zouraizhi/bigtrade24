...
export {default as CartContainer} from './containers/carts'
export {default as AboutContainer} from './containers/about'
export {default as FaqContainer} from './containers/faq'
export {default as ContactContainer} from './containers/contact'
export {default as FavoriteContainer} from './containers/favorite'
