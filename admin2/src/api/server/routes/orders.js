...
class OrdersRoute {
	...
	registerRoutes() {
		...
		this.router.post('/v1/mobile-orders', security.checkUserScope.bind(this, security.scope.WRITE_ORDERS), this.createNewOrder.bind(this));
	}
    ...
    OrdersService.createNewOrder(req.body).then(data => {
      res.send(data)
    }).catch(next);
  }
}
